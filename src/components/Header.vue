<template>
  <div class="header first-screen-top" style="padding-left: 2.2rem;" v-show="isShowMHeader">
    <div class="first-screen-search" @click="goToCategory">
      <a href="javascript:;" class="btn"></a>
      <span class="btn-search">请输入商品名称</span>
      <!-- <input type="text" class="btn-search" placeholder="请输入商品名称"> -->
    </div>
...
.first-screen-top {
  ...
  width: 100%;
  height: 1.24rem;
  padding: 0.17rem 0.32rem 0.17rem 2.2rem;
