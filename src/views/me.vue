  ...
  <div id="my" class="my">
    <div class="headerNav" style="display: none;">
      <div class="navBar" style="background: rgb(255, 255, 255);">
        ...
        ></i>
        <p class="title" style="color: rgb(51, 51, 51);">我的易果</p>
        <!---->
      </div>
    </div>
    <!---->
    <div class="myIn loginNot">
