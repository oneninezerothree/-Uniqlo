		...
		<div class="wrap">
			<form>
				<div class="input-item">
					<div class="input-item-list">
						<input type="tel" placeholder="请输入您的手机号" @focus="focues" @blur="chaxun" value maxlength="11" v-model="user" v-bind:style="color" />
					...
					<div class="input-item-list">
						<input type="password" placeholder="请再次输入您的密码" v-model="passworda" @blur="bidui" :style="isok" />
						<i class="close" style="display: none;"></i>
					</div>
				</div>
				...
				<div class="btn-login"><button type="button" class="btn_green w60p" @click="reg">注册</button></div>
			...
			<div class="mask" style="display: none;">
				<div class="content time timing">
					...
					<div class="buttons"><button class="submit">提交</button></div>
				</div>
			</div>
		</div>
	</div>
